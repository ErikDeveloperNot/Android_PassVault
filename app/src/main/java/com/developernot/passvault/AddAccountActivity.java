...
public class AddAccountActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.developernot.passvault.R.layout.activity_add_account);
        ...
        Button createAccountButton = (Button) findViewById(com.developernot.passvault.R.id.add_account_activity_create_button);
                ...
                */
                ...
                if (overrideGenerator) {
                    ...
                    if (special) {
                        ...
                        Set<String> set = prefs.getStringSet(getString(com.developernot.passvault.R.string.OVER_GEN_SPECIAL_SPECIFY_KEY), null);
                    ...
                    if (special) {
                        // get allowed special characters
                        Set<String> set = prefs.getStringSet(getString(com.developernot.passvault.R.string.GEN_SPECIAL_SPECIFY_KEY), null);
                        String[] specials = getResources().getStringArray(com.developernot.passvault.R.array.settings_activity_pass_gen_special_specify_values);
                        Log.e(TAG, lower + ":" + upper + ":" + digits + ":" + special + ":" + length + ":" + set + ":::" + specials.length);
